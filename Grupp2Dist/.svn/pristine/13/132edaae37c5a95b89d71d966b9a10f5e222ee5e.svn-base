...
namespace GolfBokning
{
    public partial class tournament : System.Web.UI.Page
    {
        ...
        {
            string sql = "INSERT INTO tournament (name, description, hcp_req, nbr_competitors, nbr_holes, id_class, id_contact, date, starttime, endtime, publish_startlist) VALUES (@name, @description, @hcp_req, @nbr_competitors, @nbr_holes, @id_class, @id_contact, @date, @starttime, @endtime, @publish_startlist) RETURNING id";
            string golfid = "";
