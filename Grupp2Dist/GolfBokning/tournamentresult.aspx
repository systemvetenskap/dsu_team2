...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tournamentResult">
        ...
        <div class="pad">
            ...
            <asp:Label class="pad" ID="LabelSecect" runat="server" Text="Välj en tävlande"></asp:Label> <br />
            ...
            <div class="pad">
            <asp:GridView ID="GridViewScore" CssClass="table table-bordered pad" runat="server" Width="20%" ></asp:GridView>
            </div>
