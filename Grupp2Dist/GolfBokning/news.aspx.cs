...
namespace GolfBokning
{
    public partial class news : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                DropDownNews.Items.Add(new ListItem("Välj nyhet...", ""));
                LoadDropDown();
            }
        ...
        private void DropDownNews_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DropDownNews.SelectedValue != "")
            {
                ...
                if (dr.Read())
                {
                    ...
                    TextBoxImageUrl.Text = dr["image"].ToString();
        ...
        private void ButtonUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@image", TextBoxImageUrl.Text);
