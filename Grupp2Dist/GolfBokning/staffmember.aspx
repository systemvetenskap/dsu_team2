...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        $(document).on("keydown", "#ContentPlaceHolder1_TextBoxSearch", function (e) {
            setTimeout(function () { $("#ContentPlaceHolder1_TextBoxSearch").focus() }, 800);
            setTimeout(function () { $("#ContentPlaceHolder1_TextBoxSearch").setCursorToTextEnd() }, 801);
        ...
        $(document).on("keydown", "#ContentPlaceHolder1_TextBoxStaffSearch", function (e) {
            setTimeout(function () { $("#ContentPlaceHolder1_TextBoxStaffSearch").focus() }, 800);
            setTimeout(function () { $("#ContentPlaceHolder1_TextBoxStaffSearch").setCursorToTextEnd() }, 801);
...
<form id="form1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanelLogin" runat="server">
        ...
        <div class="formLeft">
            ...
            <asp:ListBox ID="ListBoxMembers" runat="server" CssClass="form-control"></asp:ListBox><br /><br />
        </div>
        ...
        <div class="formRight">
            ...
            <asp:ListBox ID="ListBoxStaff" runat="server" CssClass="form-control"></asp:ListBox><br /><br /><br />
        </div>
