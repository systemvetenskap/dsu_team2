    ...
    <asp:UpdatePanel ID="UpdatePanelLogin" runat="server">
        ...
        <h1>Nyheter</h1>
            <div class="news">
                ...
                <asp:Label ID="LabelImage" runat="server" Text="Ladda upp bild"></asp:Label><br />
                <asp:Image ID="ImageExist" runat="server" /><br />
                <asp:FileUpload ID="FileUploadImage" runat="server" CssClass="file" /><br />
                <asp:Label ID="LabelImageText" runat="server" Text="Bildtext"></asp:Label><br />
                <asp:TextBox ID="TextBoxImageText" runat="server" CssClass="form-control" required="required"></asp:TextBox><br /><br />
